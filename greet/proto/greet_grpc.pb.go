...
type GreetServiceClient interface {
	...
	GreetManyTimes(ctx context.Context, in *GreetRequest1, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error)
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetRequest1, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetResponse1, error) {
	m := new(GreetResponse1)
...
type GreetService_GreetEveryoneClient interface {
	Send(*GreetRequest2) error
	Recv() (*GreetResponse2, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetRequest2) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneClient) Recv() (*GreetResponse2, error) {
	m := new(GreetResponse2)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetServiceServer interface {
	...
	GreetManyTimes(*GreetRequest1, GreetService_GreetManyTimesServer) error
...
func (UnimplementedGreetServiceServer) GreetManyTimes(*GreetRequest1, GreetService_GreetManyTimesServer) error {
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetResponse1) error {
...
type GreetService_GreetEveryoneServer interface {
	Send(*GreetResponse2) error
	Recv() (*GreetRequest2, error)
	grpc.ServerStream
}
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetResponse2) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneServer) Recv() (*GreetRequest2, error) {
	m := new(GreetRequest2)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
